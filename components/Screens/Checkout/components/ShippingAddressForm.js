...
export const ShippingAddressForm = ({
    ...
    useEffect(() => {
        if (initialValues) {
            console.log('Loading initial shipping values:', initialValues);
    ...
    const handleSubmit = () => {
        console.log('Shipping form submitting...');
        ...
        if (validateForm()) {
            ...
            console.log('Shipping form validated, data:', formData);
            console.log('Using same address for billing:', sameAsBillingAddress);

            try {
                onSubmit(formData);
            } catch (error) {
                console.error('Error submitting shipping form:', error);
                Alert.alert('Error', 'There was a problem submitting your shipping information. Please try again.');
            ...
            {sameAsBillingAddress && (
                <View style={styles.infoContainer}>
                    <Text style={styles.infoText}>
                        You'll skip the billing address step and go directly to review
                    </Text>
                </View>
            )}
